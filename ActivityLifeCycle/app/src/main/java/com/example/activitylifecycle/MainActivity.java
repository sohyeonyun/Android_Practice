...
public class MainActivity extends Activity {
    ...
    @Override
    protected void onSaveInstanceState(@NonNull Bundle outState) {          // 일시적 데이터 저장..         // onCreate의 파라미터와 관련잇..? ㅇㅇ
    ...
    @Override
    protected void onPause() {          // 영구적 데이터 저장(파일, DB에 저장)
        super.onPause();
        Log.d("####################", "onPause");
    }

    @Override
    protected void onStop() {       //자원해제
        super.onStop();
        Log.d("####################", "onStop");
    }
    ...
    //가로 모드 전환하면, 세로 창 destroy하고 가로 창을 새로 create함. --> 데이터 다 날라감. --> 걍 지원하지말자 manifest파일
